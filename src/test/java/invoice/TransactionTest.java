...
public class TransactionTest {
	...
	public void createInvoiceUpdatesTotal() throws Exception {
        ...
        @Test
        public void unknownProductIDFail() throws Exception {
            int id = myCustomer.getCustomerId();
            int before = myDAO.numberOfInvoicesForCustomer(id);
            ...
            try {
                ...
                int after = myDAO.numberOfInvoicesForCustomer(id);
        ...
        @Test
        public void negativeQuantitiesFail() throws Exception {
            int id = myCustomer.getCustomerId();
            int before = myDAO.numberOfInvoicesForCustomer(id);
        ...
        public void moreQuantitiesThanProducts() throws Exception {
            int productIDs[] = {0};
            int quantities[] = {1,1};
            myDAO.createInvoice(myCustomer, productIDs, quantities);
        }
        ...
        @Test(expected=IllegalArgumentException.class)
        public void moreProductsThanQuantities() throws Exception {
            int productIDs[] = {0,1};
            int quantities[] = {1};
            myDAO.createInvoice(myCustomer, productIDs, quantities);
        }
